  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={scheme === "dark" ? "#2778b1" : "#1864ab"}
      />
      <path
      ...
      <defs>
        ...
        >
          <stop stopColor={scheme === "dark" ? "#2778b1" : "#1864ab"} />
          <stop offset="0.619553" stopColor={scheme === "dark" ? "#1a3d66" : "#4dabf7"} />
          <stop offset="0.93102" stopColor={scheme === "dark" ? "#262a31" : "#a5d8ff"} />
        </linearGradient>
        <clipPath>
